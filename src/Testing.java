public class Testing {
    ...
    public static void main(String[] args) {
        ...
        Item item4 = new Item("The Starry Night", 4, 2022, "Katie Birch", "Painting", 2000000);
        ...
        System.out.println(ANSI_RED + "Best performing Auction house is" + ANSI_GREEN + ANSI_RESET);//Pending
